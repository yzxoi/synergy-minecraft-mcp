package com.dwinovo.numen.init;
...
public final class InitTag {
    ...
    /**
     * Items players right-click an untamed Numen with to attempt taming, and
     * the same items also heal an already-tamed Numen when its owner feeds
     * it. Datapack-driven so server admins can extend the list without code
     * changes — see {@code data/numen/tags/item/tame_foods.json}.
     */
     ...
     * see {@code data/numen/tags/block/do_not_break.json}.
     */
