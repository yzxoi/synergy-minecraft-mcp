...
public final class AStar {
    ...
    public AStarSearch newSearch(NavContext ctx, BlockPos start, BlockPos goal) {
        boolean enterable = com.dwinovo.numen.core.pathing.util.BlockHelper.canWalkThrough(ctx.view, goal)
                || ctx.costOfBreaking(goal) < com.dwinovo.numen.core.pathing.util.ActionCosts.COST_INF;
