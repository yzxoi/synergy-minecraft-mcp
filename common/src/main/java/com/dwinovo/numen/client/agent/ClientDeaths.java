 ...
 * (companion UUID → respawn epoch millis). Fed by {@code NumenDeathPayload}, cleared by
 * {@code NumenRespawnPayload}. Read by the HUD and the panel rail to show the death state —
