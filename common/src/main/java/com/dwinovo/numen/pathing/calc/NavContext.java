...
public final class NavContext {
     ...
     * {@link com.dwinovo.numen.pathing.movement.Moves}) go through it. For EXECUTION it's a
     ...
     * {@link com.dwinovo.numen.pathing.util.BlockHelper} reads either unchanged.
     */
    ...
    public static NavContext forSearch(Level level, Container liveInventory) {
        ...
        com.dwinovo.numen.pathing.cache.LoadedChunks loaded =
                com.dwinovo.numen.pathing.cache.PathCaches.peek(level);
        ...
        BlockGetter view = loaded != null
                ? new com.dwinovo.numen.pathing.cache.CachedNavView(loaded, level)
