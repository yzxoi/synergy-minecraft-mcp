...
public final class BlockMiningProgress {
     ...
     * consult {@link com.dwinovo.numen.pathing.util.BlockHelper#fluidReleasedByBreaking}
    ...
    public static String fluidBreakHazard(Level level, BlockPos pos) {
        net.minecraft.core.Direction dir =
                com.dwinovo.numen.pathing.util.BlockHelper.fluidReleasedByBreaking(level, pos);
