...
public final class Placement {
     ...
     */
    public static BlockHitResult resolve(TulpaPlayer player, BlockPos placeAt, boolean wouldSneak) {
    ...
    private static BlockHitResult reachSupport(TulpaPlayer player, BlockPos placeAt, double reach, boolean wouldSneak) {
    ...
    private static BlockHitResult reachBlock(TulpaPlayer player, BlockPos placeAt, double reach, boolean wouldSneak) {
        Level level = player.level();
    ...
    private static BlockHitResult castFromEye(TulpaPlayer player, Vec3 point, double reach,
