...
public final class Interaction {
    ...
    private Interaction(TulpaPlayer player, Button button, BlockPos block, Entity entity,
    ...
    public static Interaction attackBlock(TulpaPlayer p, BlockPos pos) {
    ...
    public static Interaction attackEntity(TulpaPlayer p, Entity target) {
        return attackEntity(p, target, Timing.once());
    }

    public static Interaction attackEntity(TulpaPlayer p, Entity target, Timing timing) {
    ...
    public static Interaction useBlock(TulpaPlayer p, BlockPos pos, InteractionHand hand) {
    ...
    public static Interaction useBlock(TulpaPlayer p, BlockHitResult hit, InteractionHand hand) {
    ...
    public static Interaction useEntity(TulpaPlayer p, Entity target, InteractionHand hand) {
    ...
    public static Interaction useInAir(TulpaPlayer p, InteractionHand hand, Timing timing) {
     ...
     */
    public static HitResult nativeRaytrace(TulpaPlayer player, double reach) {
     ...
     */
    public static Interaction forHit(TulpaPlayer p, HitResult hit, Button button, int holdTicks) {
