...
import com.dwinovo.tulpa.pathing.exec.BlockDigger;
...
import com.dwinovo.tulpa.pathing.util.ScanExecutor;
...
public final class MineCompanionTask implements CompanionTask {
    ...
    public MineCompanionTask(TulpaPlayer player, MineBlockTaskRecord record) {
        this.player = player;
        this.r = record;
