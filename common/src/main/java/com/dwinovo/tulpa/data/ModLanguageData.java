...
public final class ModLanguageData {
    ...
    public static final class Keys {
        ...
        // Settings GUI labels.
        public static final String GUI_SETTINGS_TITLE       = "tulpa.gui.settings.title";
        public static final String GUI_SETTINGS_PROVIDER    = "tulpa.gui.settings.provider";
        public static final String GUI_SETTINGS_API_KEY     = "tulpa.gui.settings.api_key";
        public static final String GUI_SETTINGS_MODEL       = "tulpa.gui.settings.model";
        public static final String GUI_SETTINGS_BASE_URL    = "tulpa.gui.settings.base_url";
        public static final String GUI_SETTINGS_BASE_URL_HINT = "tulpa.gui.settings.base_url_hint";
        public static final String GUI_SETTINGS_SAVE        = "tulpa.gui.settings.save";
        public static final String GUI_SETTINGS_CANCEL      = "tulpa.gui.settings.cancel";
        public static final String GUI_SETTINGS_SAVED       = "tulpa.gui.settings.saved";

        /** Hotkey: open the companion roster panel (shown in Controls settings). */
        public static final String KEY_OPEN_ROSTER = "key.tulpa.open_roster";
    }
    ...
    private static void addEn(Adder adder) {
        adder.add(Keys.GUI_SETTINGS_TITLE,         "Tulpa Settings");
    ...
    private static void addZh(Adder adder) {
        adder.add(Keys.GUI_SETTINGS_TITLE,         "Tulpa 设置");
