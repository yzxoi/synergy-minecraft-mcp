 ...
 * No HTTP I/O (that's {@link com.dwinovo.tulpa.agent.http.HttpLlmTransport}),
...
public interface LlmProvider {
     ...
     * {@code TulpaLlmClient} during URL composition.
     *
    ...
    /** Build the {@code tools} array from our internal {@link TulpaTool} registry. */
    JsonArray buildToolList(Collection<TulpaTool> tools);
