...
public interface TulpaTool {
     ...
     */
    default void startAsyncQuery(JsonObject args, com.dwinovo.tulpa.entity.TulpaPlayer entity,
     ...
     */
    default String executeQuery(JsonObject args, com.dwinovo.tulpa.entity.TulpaPlayer entity) {
        throw new UnsupportedOperationException(
