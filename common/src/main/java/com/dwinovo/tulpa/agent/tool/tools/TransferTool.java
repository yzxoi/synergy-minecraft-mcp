 ...
 */
public final class TransferTool implements TulpaTool {
    ...
    private static String route(AbstractContainerMenu menu, TulpaPlayer entity, int from, Integer count) {
    ...
    private static String place(AbstractContainerMenu menu, TulpaPlayer entity, int from, int to, Integer count) {
        if (from == to) {
